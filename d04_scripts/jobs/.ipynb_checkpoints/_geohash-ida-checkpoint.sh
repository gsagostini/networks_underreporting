...
#SBATCH -J inference-hash-ida                                     # Job name
...
python3 ../inference.py --j "$SLURM_ARRAY_TASK_ID" --graph_type 'geohash' --dataset "floods" --event 'ida' --train_cutoff "percentage" --train_percentage "0.08" --MCMC_n_iter "60_000" --MCMC_n_burnin "20_000" --covariates